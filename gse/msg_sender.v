...
always @(*) begin
    case (byte_index)
    3'd0: cur_byte = active_msg[47:40];
    3'd1: cur_byte = active_msg[39:32];
    3'd2: cur_byte = active_msg[31:24];
    3'd3: cur_byte = active_msg[23:16];
    3'd4: cur_byte = active_msg[15:8];
    3'd5: cur_byte = active_msg[7:0];
